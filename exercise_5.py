...
number_of_questions = float(input("Enter the number of questions: "))

# prompting the teacher to enter the number of questions the student answered correctly
number_of_questions_answered_correctly = float(input("Enter the number of questions student answered correctly: "))

# prompting the teacher to enter the number of points each question is worth
number_of_points_each_worth =float(input("Enter the points each question is worth: "))
